...
#Install PHP7.2
rpm -Uvh https://aomenbt.github.io/webtatic-release.rpm
...
# Install FFMPEG
cd ~
wget --no-check-certificate https://aomenbt.github.io/ffmpeg-release-64bit-static.tar.xz
...
# Install unrar
cd ~
wget --no-check-certificate https://aomenbt.github.io/rarlinux-x64-5.6.b2.tar.gz
if [ $? -eq 0 ];then
...
# Install libtorrent
cd ~
wget https://aomenbt.github.io/libtorrent-0.13.6.tar.gz
if [ $? -eq 0 ];then
...
# Install rTorrent
cd ~
wget https://aomenbt.github.io/rtorrent-0.9.6.tar.gz
if [ $? -eq 0 ];then
...
# Download ruTorrent
cd /usr/share/nginx
wget --no-check-certificate https://aomenbt.github.io/v3.8.tar.gz
if [ $? -eq 0 ];then
...
git clone https://github.com/aomenbt/ruTorrent-MaterialDesign.git
chown -R apache:apache ruTorrent-MaterialDesign
git clone https://github.com/aomenbt/club-QuickBox.git
...
cd /etc/init.d
wget --no-check-certificate https://raw.githubusercontent.com/aomenbt/aomenbt.github.io/master/rtorrent
chmod 755 rtorrent
